...
const Hero = () => {
  return (
    <div className='min-h-screen flex items-center justify-center bg-cyan-100 dark:bg-slate-900 py-24 '>
      <div className='align-elements grid md:grid-cols-2 items-center gap-8'>
        ...
        >
          ...
          <p className='mt-2 text-lg tracking-wide text-slate-700 dark:text-slate-300'>
            I craft responsive and accessible user interfaces with modern tools
            like React, Tailwind, and a touch of flair.
          </p>
